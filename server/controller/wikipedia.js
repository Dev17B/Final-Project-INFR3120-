...
module.exports.displayAddPage = (req,res,next)=>{
    res.render('wikipedia/add',{title:'Add the informaiton you like to add'})
...
module.exports.displayEditPage = (req,res,next)=> {
    ...
    Wikipedia.findById(id,(err,wikipediaToEdit) => {
        ...
        {
            res.render('wikipedia/edit',{title:'Edit the mission information', wikipedia:wikipediaToEdit});
        }
    });
}
