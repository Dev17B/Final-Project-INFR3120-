...
module.exports.displayAddPage2 = (req,res,next)=>{
    res.render('wikipedia2/add2',{title:'Add the informaiton you like to add'})
...
module.exports.displayEditPage2 = (req,res,next)=> {
    ...
    Wikipedia2.findById(id,(err,wikipedia2ToEdit) => {
        ...
        {
            res.render('wikipedia2/edit2',{title:'Edit the mission information', wikipedia2:wikipedia2ToEdit});
        }
    });
}
