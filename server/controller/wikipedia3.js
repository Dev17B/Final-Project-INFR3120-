...
module.exports.displayAddPage3 = (req,res,next)=>{
    res.render('wikipedia3/add3',{title:'Add the informaiton you like to add'})
...
module.exports.displayEditPage3 = (req,res,next)=> {
    ...
    Wikipedia3.findById(id,(err,wikipedia3ToEdit) => {
        ...
        {
            res.render('wikipedia3/edit3',{title:'Edit the mission information', wikipedia3:wikipedia3ToEdit});
        }
    });
}
