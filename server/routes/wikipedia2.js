...
router.get('/add2', wikipediaController2.displayAddPage2);
/* post route for processing  the add page -- create operation  */
router.post('/add2',wikipediaController2.processAddPage2);

/* edit operation 
Get route for displaying the edit operation -- update operation */
router.get('/edit2/:id',wikipediaController2.displayEditPage2);
/*post route for displaying  the edit operation -- update operation  */
router.post('/edit2/:id',wikipediaController2.processEditPage2);
/* delete operation */
/* Get to perform delete operation -- update Deletion */

router.get('/delete2/:id',wikipediaController2.performDelete2);
/* Get to perform delete operation -- update Deletion */
