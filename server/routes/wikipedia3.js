...
router.get('/add3', wikipediaController3.displayAddPage3);
/* post route for processing  the add page -- create operation  */
router.post('/add3',wikipediaController3.processAddPage3);

/* edit operation 
Get route for displaying the edit operation -- update operation */
router.get('/edit3/:id',wikipediaController3.displayEditPage3);
/*post route for displaying  the edit operation -- update operation  */
router.post('/edit3/:id',wikipediaController3.processEditPage3);
/* delete operation */
/* Get to perform delete operation -- update Deletion */

router.get('/delete3/:id',wikipediaController3.performDelete3);
/* Get to perform delete operation -- update Deletion */
